...
import { SearchCode, CheckCircle2, Clock, ChevronDown, ChevronUp, FileText, Sparkles } from 'lucide-react';

export default function InvestigationsView({ cases = [], onSelectCase }) {
  const [expandedCaseId, setExpandedCaseId] = useState('#RV-4821');
          ...
          return (
            <div 
              ...
              className={`bg-white rounded-lg border transition-all overflow-hidden ${
                c.id === '#RV-4821' ? 'border-indigo-300 shadow-2xs' : 'border-slate-200'
              }`}
            >
              {/* Case Bar */}
              <div 
                ...
                <div className="p-6 space-y-4 bg-white">
                  ...
                  {c.evidence && (
                    <div className="pt-2">
                      ...
                      <p className="text-xs text-slate-700 bg-indigo-50/50 border border-indigo-100 p-3 rounded">
