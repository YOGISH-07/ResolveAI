...
import { Search, RotateCcw, Play, ShieldCheck, HelpCircle } from 'lucide-react';
    ...
    <header className="bg-white border-b border-slate-200 px-6 py-3.5 flex items-center justify-between shadow-xs select-none shrink-0">
      ...
      <div className="flex items-center space-x-3">
        ...
        >
          ...
          <span>{demoStep !== null ? `Demo Step ${demoStep + 1}/7` : '3-Min Hackathon Demo Tour'}</span>
        </button>
        ...
        <button
          ...
          className="flex items-center space-x-1.5 px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md text-xs font-medium border border-slate-200 transition-colors"
        >
