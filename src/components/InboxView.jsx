...
import { Search, Filter, ArrowUpDown, ChevronRight, Sparkles, Inbox as InboxIcon } from 'lucide-react';

export default function InboxView({ cases = [], onSelectCase, searchQuery, setSearchQuery }) {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 text-right whitespace-nowrap">
                      <button className="px-3 py-1 bg-white hover:bg-slate-100 border border-slate-200 rounded text-[11px] font-semibold text-indigo-700 inline-flex items-center space-x-1 shadow-2xs">
