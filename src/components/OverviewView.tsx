...
export default function OverviewView({ cases = [], onSelectCase, onNavigateInbox }: OverviewViewProps) {
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <button
          ...
          className="flex items-center space-x-2 px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md text-xs font-semibold shadow-xs cursor-pointer transition-colors self-start"
        >
            ...
            return (
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 flex-wrap gap-y-1">
                      <span className="text-sm font-bold text-slate-900">#{c.id.replace('#', '')}</span>
                ...
                <div className="flex items-center justify-between md:justify-end space-x-4 shrink-0">
                  ...
                  <button className={`p-2 rounded-md transition-colors cursor-pointer ${
