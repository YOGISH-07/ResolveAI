...
export default function Sidebar({ activeTab, setActiveTab, counts = {} }) {
  const navItems = [
    ...
    { id: 'inbox', label: 'Inbox', icon: Inbox, badge: counts.open || 5 },
    { id: 'investigations', label: 'Investigations', icon: SearchCode, badge: null },
    ...
    { id: 'architecture', label: 'System / Architecture', icon: Cpu, badge: null },
  ];
    ...
    <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen border-r border-slate-800 shrink-0 select-none">
      ...
      <div className="p-5 border-b border-slate-800/80 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="w-9 h-9 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-black tracking-wider text-base shadow-sm">
            R
          </div>
          <div>
