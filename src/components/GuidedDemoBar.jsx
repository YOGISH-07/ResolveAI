...
export default function GuidedDemoBar({ 
  ...
  const steps = [
    ...
    },
    {
      ...
      actionHint: "Click the 'Run AI Investigation' button."
    },
    {
      num: 4,
    ...
    },
    {
      ...
      actionHint: "Click 'Initiate Refund' and confirm."
    },
    {
      num: 6,
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-1">
          <button
            ...
            className="p-1 rounded bg-slate-800 hover:bg-slate-700 disabled:opacity-40 text-slate-300 text-xs transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1 px-2.5 py-1 rounded bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs shadow-sm transition-colors"
          >
            <span>Next Step</span>
